package com.example.cupcake.Mapper;
...
public class ConnectionPool
{
    ...
    private static String USER = "matechsolutions_dk";
    private static String PASSWORD = "cenyktwx";
    private static String URL = "jdbc:mysql://mysql11.unoeuro.com:3306/matechsolutions_dk_db";
